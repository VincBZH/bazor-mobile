...
# Contrôle rapide, sans extraction, de la volumineuse archive Mammouth du Bureau.
# GitHub héberge le code source mais ne peut attester que cette sauvegarde locale
# de 4,85 Go est redondante; ne pas la supprimer tant que ce n'est pas prouvé.
$archiveCheck=@()
...
$summary+=@("","INSPECTION ARCHIVE MAMMOUTH (pas de suppression automatique):")
