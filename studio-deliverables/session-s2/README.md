# Studio Session S2.3 — transmission aux entités BAZOR
...
S2.3 : Hailuo/API exclu des routes locales, topologie H3 native, fiche du prompt effectif, préparation anglaise séparée et mots-clés de style optionnels. Consulter CI_RESULT.json pour le commit testé ; la fidélité du rendu nécessite encore une génération GPU réelle.
